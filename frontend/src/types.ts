...
export interface Car { id:number; name:string|null; cool:boolean; color:string|null }
export interface Coordinates { id:number; x:string; y:number }
export interface Human {
 id:number; name:string; coordinates:Coordinates; creationDate:string;
